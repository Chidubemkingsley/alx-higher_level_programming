...
<details>- Pycodestyle is now the new standard of Python style code.
...
- [0x01](./0x01-python-if_else_loops_functions) : if/else, loops- [0x10](./0x10-python-network_0) : Python - Network #0.
- [0x11](./0x11-python-network_1) : Python - Network #1., functions.
